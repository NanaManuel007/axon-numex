...
// import type { I18n } from "../i18n";
// import graLogo from "../../login/assets/img/gra.png";
import numexLogo from "../../login/assets/img/numex_logo.png";
// import { useState } from "react";
...
const LoginPage = (props: PageProps<"login.ftl">) => {
  ...
  return (
    <Template i18n={i18n} kcContext={kcContext} >
      ...
      <div></div>
        <img src={numexLogo} alt="gra logo" className="w-[200px] object-cover absolute top-[50px] pb-10" />
        <span className="w-[200px] text-xs object-cover absolute top-[130px] pb-10 pl-10
         text-gray-400
        ">Welcome to Numex!</span>

 <div className="flex flex-col items-center justify-center font-poppins relative pt-20">
        {/* <img src={graLogo} alt="gra logo" className="w-[100px] object-cover absolute top-[130px] z-20 pb-10" /> */}
      <div className=" w-[570px] overflow-hidden bg-white rounded-lg shadow-xl h-[510px] ">
        <div className="flex flex-col pt-20">
            {/* <h1 className="  w-full text-center text-3xl font-bold text-gray-800  pt-20">Sign In MTS</h1> */}
            <div className=" px-16 pt-10 pb-5">
                <div className=" pb-5">
                <div className="relative">
                            <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none">
                            ...
                            <input
                                type="text"
                                className="w-full pl-3 pr-4 py-3 bg-transparent border-b-[1px] border-gray-300 focus:outline-none focus:border-blue-400 text-[12px] transition-colors"
                                placeholder={loginWithEmailAllowed ? msgStr('usernameOrEmail') : msgStr('username')}
                                name="username"
                                id="username"
                            />
                ...
                <button
                            type="submit"
                            className="w-full bg-[#00aceb] text-white font-medium py-3 px-6 rounded-md transition duration-200 hover:bg-[#0088bb] mt-6 text-[12px]"
                        >
                          {msgStr('doLogIn')}
                        </button>
            </div>

           <div className="text-[12px] px-10 pb-10">
